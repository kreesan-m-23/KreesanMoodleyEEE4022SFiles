...
- Source code can be changed in the 'main.c' files eg. PSC values as STM32 CubeMX generates organised and readable source code.This means that parameters do not have to be changed in STM32 CubeMX each time which would require re-generation of source code.
